	...
	data(){
		return{
			...
			table: {
				itemsPerPage: 10,
				headers: [
					{ title: 'ID Port', align: 'start', key: 'name' },
				...
				data: [
					{id: 0, name: 'netengi-instance-1', fixed_ip: '95.163.248.0/22', mac: '00-0a-83-b1-c0-8e', device: '-', admin: '-', region: {country: 'ua', name: 'ua-central-1'}},
				]
			},
			modalItem: {},
			modalDelete: false,
