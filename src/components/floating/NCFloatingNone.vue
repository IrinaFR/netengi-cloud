<template>
	<div class="infoCreateInstance">
		<div class="blockWithBtn">
			<div class="title">You have no floating IPs right now.</div>
			<div class="listBtn">
				<v-btn density="default" to="/floating/create" variant="tonal">Create Floating IP</v-btn>
			...
			<div class="btnLern">
				...
				<span>Learn more about floating IP</span>
			</div>
		</div>
		<v-card class="blockBanner">
			...
			<div class="banner">
				<v-img class="lineBlock" src="/images/menu/floatingIp.svg"></v-img>
				<v-img class="whiteBox" src="/images/instances/whiteBox.svg"></v-img>
			</div>
			<div class="textBanner">
				<div class="greyTitle">Video Instruction</div>
				<div class="request">How create my first a floating IP?</div>
			</div>
		</v-card>
	</div>
</template>
