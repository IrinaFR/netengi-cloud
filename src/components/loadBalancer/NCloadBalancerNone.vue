<template>
	<div class="infoCreateInstance">
		<div class="blockWithBtn">
			<div class="title">You have no load balancers right now.</div>
			<div class="listBtn">
				<v-btn density="default" to="/balancer/create" variant="tonal">Create Load Balancer</v-btn>
			</div>

			<div class="btnLern">
				<v-img src="/images/general/link.svg"></v-img>
				<span>Learn more about load balancers</span>
			</div>
		</div>
		<v-card class="blockBanner">
			...
			<div class="banner">
				<v-img class="lineBlock" src="/images/menu/loadBalancer.svg"></v-img>
				<v-img class="whiteBox" src="/images/instances/whiteBox.svg"></v-img>
			</div>
			<div class="textBanner">
				<div class="greyTitle">Video Instruction</div>
				<div class="request">How create my first a load balancer?</div>
			</div>
		</v-card>
	</div>
</template>
