<template>
	<div class="infoCreateInstance">
		<div class="blockWithBtn">
			<div class="title">You have no images right now.</div>
			<div class="listBtn">
				<v-btn density="default" to="/images/create" variant="tonal">Create Image</v-btn>
			...
			<div class="btnLern">
				...
				<span>Learn more about images</span>
			</div>
		</div>
