<template>
	...
	<v-table density="compact" class="tableMain">
		...
		>
			...
			<td class="tableName">
				<router-link :to="`/ports/${item.id}`">{{ item.name }}</router-link>
			</td>
			<td>
...
export default {
	...
	data(){
		return{
			table: [
				{id: 1, check: false, name: '4753f76c-72f3-47f2-5f2e-4753f76c-72f3-47f2-5f2e', state: 1, ips: '192.168.0.1', mac: 'fa:01:rw:50:3e:6y', owner: 'network:dhcp', admin: true, region: {country: 'ua', name: 'ua-central-1'}},
				{id: 2, check: false, name: '4753f76c-72f3-47f2-5f2e', state: 2, ips: '192.168.0.1', mac: '31:fa:f7:b9:33:q1', owner: 'compute:nova', admin: false, region: {country: 'ua', name: 'ua-central-1'}},
				{id: 3, check: false, name: '4753f76c-72f3-47f2-5f2e', state: 1, ips: '192.168.0.1', mac: 'fa:01:rw:50:3e:6y', owner: 'network:dhcp', admin: true, region: {country: 'pl', name: 'pl-central-23'}},
				{id: 4, check: false, name: '4753f76c-72f3-47f2-5f2e', state: 2, ips: '192.168.0.1', mac: '31:fa:f7:b9:33:q1', owner: 'network:dhcp', admin: false, region: {country: 'ua', name: 'ua-central-1'}},
				{id: 5, check: false, name: '4753f76c-72f3-47f2-5f2e', state: 2, ips: '192.168.0.1', mac: '31:fa:f7:b9:33:q1', owner: 'compute:nova', admin: false, region: {country: 'pl', name: 'pl-central-23'}},
				{id: 6, check: false, name: '4753f76c-72f3-47f2-5f2e', state: 1, ips: '192.168.0.1', mac: 'fa:01:rw:50:3e:6y', owner: 'network:dhcp', admin: true, region: {country: 'pl', name: 'pl-central-23'}},
				{id: 7, check: false, name: '4753f76c-72f3-47f2-5f2e', state: 1, ips: '192.168.0.1', mac: 'fa:01:rw:50:3e:6y', owner: 'network:dhcp', admin: false, region: {country: 'ua', name: 'ua-central-1'}}
			],
			sizeList: 10,
			page: 1,
		}
