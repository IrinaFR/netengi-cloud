		...
		return{
			...
			table: {
				...
				headers: [
					...
					{ title: 'Fixed IPs', align: 'start', key: 'ips' },
					{ title: 'MAC Address', align: 'start', key: 'mac' },
					{ title: 'Device Owner', align: 'start', key: 'owner' },
					{ title: 'Admin State Up', align: 'start', key: 'admin' },
					{ title: 'Placement Region', align: 'start', key: 'region.name' },
					{ title: '', key: 'actions', align: 'end', sortable: false }
				],
				data: [
					{id: 1, name: '4753f76c-72f3-47f2-5f2e-4753f76c-72f3-47f2-5f2e', state: 1, ips: '192.168.0.1', mac: 'fa:01:rw:50:3e:6y', owner: 'network:dhcp', admin: 'Yes', region: {country: 'ua', name: 'ua-central-1'}},
					{id: 2, name: '4753f76c-72f3-47f2-5f2e', state: 2, ips: '192.168.0.1', mac: '31:fa:f7:b9:33:q1', owner: 'compute:nova', admin: 'No', region: {country: 'ua', name: 'ua-central-1'}},
					{id: 3, name: '4753f76c-72f3-47f2-5f2e', state: 1, ips: '192.168.0.1', mac: 'fa:01:rw:50:3e:6y', owner: 'network:dhcp', admin: 'Yes', region: {country: 'pl', name: 'pl-central-23'}},
					{id: 4, name: '4753f76c-72f3-47f2-5f2e', state: 2, ips: '192.168.0.1', mac: '31:fa:f7:b9:33:q1', owner: 'network:dhcp', admin: 'No', region: {country: 'ua', name: 'ua-central-1'}},
					{id: 5, name: '4753f76c-72f3-47f2-5f2e', state: 2, ips: '192.168.0.1', mac: '31:fa:f7:b9:33:q1', owner: 'compute:nova', admin: 'No', region: {country: 'pl', name: 'pl-central-23'}},
					{id: 6, name: '4753f76c-72f3-47f2-5f2e', state: 1, ips: '192.168.0.1', mac: 'fa:01:rw:50:3e:6y', owner: 'network:dhcp', admin: 'Yes', region: {country: 'pl', name: 'pl-central-23'}},
					{id: 7, name: '4753f76c-72f3-47f2-5f2e', state: 1, ips: '192.168.0.1', mac: 'fa:01:rw:50:3e:6y', owner: 'network:dhcp', admin: 'No', region: {country: 'ua', name: 'ua-central-1'}}
				]
			},
			modalItem: {},
			modalDelete: false,
